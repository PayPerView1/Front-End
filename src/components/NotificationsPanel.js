...
export default function NotificationsPanel({ side = "left" }) {
  ...
  return (
    <aside
      className={`fixed top-[64px] h-[calc(100vh-64px)] w-[500px] max-w-[500px] z-40 flex flex-col overflow-y-auto border transition-all duration-300 ${sideClass} ${t.border}`}
      style={{
