...
export default function ForgotPassword() {
  ...
  return (
    <main className="relative min-h-screen w-full flex items-center justify-center p-4 overflow-hidden" dir="rtl">
      ...
      <div className="relative z-10 w-full max-w-[480px] bg-white/[0.02] border border-white/10 rounded-[16px] backdrop-blur-[4px] shadow-[0_32px_64px_0_rgba(0,0,0,0.5)] p-8 flex flex-col items-center animate-in fade-in zoom-in-95 duration-500">

        {/* Gap container to maintain exact 38px spacing natively */}
